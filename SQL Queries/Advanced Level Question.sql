...
/*Que1: Calculate the moving average of order values for each customer over their order history*/
SELECT 
    customer_id, 
...
/*Que2: Calculate the cumulative sales per month for each year*/
...
/*Que3: Calculate the year-over-year growth rate of total sales*/
WITH YearlySales AS (
    SELECT 
...
/*Que4: Calculate the retention rate of customers, defined as the percentage of customers who make another purchase within 6 months of their first purchase*/
...
/*Que5: Identify the top 3 customers who spent the most money in each year*/
